...
def corelogram(matrice=None, dec=1, titlu='Correlogram', valMin=-1, valMax=1):
...
def corrCircle(matrice=None, X1=0, X2=1, raza=1, dec=2, titlu='Correlation Circle',
...
def graphPCA(valoriProprii=None, titlu='Varianta/STDev explained by principal components',
                         etichetaX='Principal Components', etichetaY='Variance explained - valori proprii'):
...
def scatterPlot(matrice=None, titlu='Scatter Plot', etichetaX='Variabels',
              etichetaY='Observations'):
    plt.figure(titlu, figsize=(15, 11))
    plt.title(titlu, fontsize=14, color='k', verticalalignment='bottom')
